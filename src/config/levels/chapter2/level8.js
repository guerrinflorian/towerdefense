export const LEVEL_8 = {
  ...
  waves: [
    ...
    [
      { count: 32, type: "grunt", interval: 400, startDelay: 0 },
      { count: 5, type: "criard", interval: 1600, startDelay: 1000 },
      { count: 4, type: "stratege", interval: 2400, startDelay: 4000 },
      { count: 5, type: "brouilleur", interval: 1600, startDelay: 7000 },
      { count: 4, type: "shaman_gobelin", interval: 2300, startDelay: 9000 },
      { count: 22, type: "runner", interval: 290, startDelay: 10000 },
      { count: 2, type: "slime", interval: 2400, startDelay: 5000 },
      { count: 5, type: "tank", interval: 2800, startDelay: 14000 },
    ],

    // VAGUE 8 : Avant le boss
    [
      { count: 36, type: "grunt", interval: 380, startDelay: 0 },
      { count: 6, type: "criard", interval: 1500, startDelay: 1000 },
      { count: 5, type: "stratege", interval: 2200, startDelay: 3500 },
      { count: 6, type: "brouilleur", interval: 1500, startDelay: 6000 },
      { count: 5, type: "shaman_gobelin", interval: 2200, startDelay: 8000 },
      { count: 26, type: "runner", interval: 260, startDelay: 9000 },
      { count: 8, type: "tank", interval: 2600, startDelay: 13000 },
    ],

    // VAGUE 9 : BOSS FINAL
    [
      { count: 40, type: "grunt", interval: 360, startDelay: 0 },
      { count: 8, type: "criard", interval: 1400, startDelay: 1000 },
      { count: 7, type: "stratege", interval: 2000, startDelay: 3000 },
      { count: 8, type: "brouilleur", interval: 1400, startDelay: 5000 },
      { count: 7, type: "shaman_gobelin", interval: 2100, startDelay: 7000 },
      { count: 30, type: "runner", interval: 230, startDelay: 8000 },
      { count: 8, type: "tank", interval: 2400, startDelay: 12000 },
      { count: 3, type: "vampire", interval: 1700, startDelay: 2500 },
